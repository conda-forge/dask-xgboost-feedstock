About dask-xgboost-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dask-xgboost-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5081&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dask-xgboost-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dask-xgboost` can be installed with `conda`:
...
```
mamba install dask-xgboost
```

It is possible to list all of the versions of `dask-xgboost` available on your platform with `conda`:
...
```
mamba search dask-xgboost --channel conda-forge
```
...
mamba repoquery search dask-xgboost --channel conda-forge

# List packages depending on `dask-xgboost`:
mamba repoquery whoneeds dask-xgboost --channel conda-forge

# List dependencies of `dask-xgboost`:
mamba repoquery depends dask-xgboost --channel conda-forge
```
